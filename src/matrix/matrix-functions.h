...
class SvdRescaler {
 public:
  /*
    ...
    special case of SVD.
  */
  SvdRescaler(const MatrixBase<BaseFloat> &A, bool symmetric = false);
  ...
  void Init(const MatrixBase<BaseFloat> *A, bool symmetric = false);
 ...
 protected:
    ...
    Vector<BaseFloat> lambda_in_, lambda_out_, lambda_out_deriv_;
};
